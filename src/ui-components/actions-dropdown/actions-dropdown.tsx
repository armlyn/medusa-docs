    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenu.Content>
          {order && order.metadata && order.metadata["invoice_id"] && (
            <ViewInvoiceDropdownButton order={order} />
          )}
          <GenerateInvoiceDropdownButton order={order} />
          <DropdownMenu.Separator />
          {order && order.metadata && order.metadata["packing_slip_id"] && (
            <ViewPackingSlipDropdownButton order={order} />
          )}
